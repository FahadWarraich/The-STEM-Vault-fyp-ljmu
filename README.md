...
```bash
git clone https://github.com/FahadWarraich/The-STEM-Vault-fyp-ljmu.git
cd stem-vault
```
...
**Step 1: Ensure Build Configuration is Correct**
Make sure your android/app/build.gradle contains:

* gradle
* Copy
* Edit
* defaultConfig {
   applicationId "com.example.stemvault"
   minSdkVersion 21
   targetSdkVersion 33
   ...
}
...
* flutter build apk --target lib/features/main.dart --release

**Step 3: Locate the APK**
After the build completes, the release APK will be found at:
...
### A pre-built APK file has been uploaded to this designated Drive folder. You may download and install it on any compatible Android device.
https://drive.google.com/drive/folders/1KBY05nOauIoyOxtOQLq8-4wVjt11wr6A?usp=sharing
